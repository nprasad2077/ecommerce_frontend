...
export default function PlaceOrderPage() {
  ...
  useEffect(() => {
    try {
      ...
      setToastMessage(
        "Error loading your order information. Please try again."
      );
      setToastType("error");
      setShowToast(true);
    }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You need to add some items to your cart before placing an order.
          </p>
          <button
            onClick={() => navigate("/")}
              ...
              <div className="p-6">
                <div className="divide-y">
                  {cart.map((item) => (
                    <div
                      key={item.product}
                      className="py-4 first:pt-0 last:pb-0 flex items-center"
                    >
                ...
                <div className="space-y-4">
                  ...
                  {cart.length === 0 && (
                    <p className="text-sm text-red-600 mt-2">
                      Your cart is empty. Add some products before placing
                      order.
                    </p>
                  )}
                </div>
