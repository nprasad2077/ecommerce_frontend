...
import { Users, Search, Trash2, Edit, CheckCircle, X, PlusCircle, Download, RefreshCw } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 flex justify-between items-center">
          ...
          <button
            className="flex items-center justify-center px-4 py-2 text-sm text-gray-700 hover:text-gray-900"
          >
